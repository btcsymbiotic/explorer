  ...
  function initMap() {
    if(document.getElementById('map')) {
      var locations = [
        ...
        ['newpool.pw', 45.7386, 37.6068, 12, 'http://newpool.pw/', 'Russia', false, 'sanich#1050', true, ['support','RU'], ['lottery','Win 220 BTCS!']],
        ...
        ['youpool.io/BTCS', 30.2936, 120.1614, 17, 'http://youpool.io/BTCS', 'CN - Hangzhou', true, 'youpool.io#7823',true, ['support','EN/CN'], ['','']]
      ];
